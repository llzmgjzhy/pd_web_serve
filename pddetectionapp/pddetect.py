...
class Bi_lstm(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_size):
        ...
        self.ls1 = nn.LSTM(input_size=3, hidden_size=32, num_layers=1, bidirectional=False, batch_first=True)
...
async def PD_detect(new_data):
    ...
    model.load_state_dict(torch.load('pddetectionapp/models/state_dict_{}.pth'.format(1), map_location=torch.device('cpu')))
